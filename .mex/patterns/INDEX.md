---
name: patterns-index
description: Pattern index for New Project.
---
...
| `.mex/patterns/self-iterative-lifecycle.md` | Self-iterative lifecycle for tool-driven diagnosis, numbered runtime files under `SELF-ITERATIVE/`, scoped implementation, generated-result inspection, `.mex` updates, PR, CodeRabbit, and merge. |
