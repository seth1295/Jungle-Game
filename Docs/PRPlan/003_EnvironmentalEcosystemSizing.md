...
This document defines practical ecosystem sizing for the large-world first playable. Ecosystems must be sized from environmental and landform logic, not arbitrary game-biome blocks.
...
| Macro region | 4 km to 16 km across | Whole-world organizing regions: mountain spine, lowland basin, gorge corridor, outer wet uplands |
